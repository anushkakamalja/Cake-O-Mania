                ...
                <section className="">
                    <div className="">
                        ...
                        <form className="pt-10" action="" method="POST">
                            ...
                            <button className="transition duration-500 ease-in-out text-xl font-body rounded-2xl m-4 px-4 py-2 bg-black text-white hover:bg-myCyan-100 transform hover:-translate-y-1 hover:scale-110 " type="submit" id="login-button">
                                LOGIN NOW
                            </button>
                        </form>
                        ...
                        <div className="">
                            <a href="/auth/google">
                                <button className=" transition duration-500 ease-in-out text-xl font-body rounded-2xl m-4 px-4 py-2 bg-black text-white hover:bg-myCyan-100 transform hover:-translate-y-1 hover:scale-110 " type="submit" >
                        ...
                        <div className="hover:bg-red font-body text-lg flex flex-row justify-between w-2/5 m-auto">
                            ...
                            <p>
                                <a href="/signup" className="p-1 underline transform transition duration-500 hover:scale-110 hover:bg-black hover:text-white ">Sign up Now!</a>
                            </p>
                        </div>
                    </div>
                </section>
