    ...
    return (
        <div className="flex min-h-screen">
            ...
            <div className="flex flex-col items-center w-full p-10">
                <h2 className="text-xl md:text-3xl mt-4 font-body uppercase font-bold">
                    Welcome Back
                </h2>
                <h3 className="text-3xl md:text-5xl mt-2 font-body font-bold">
                    Log into your account
                </h3>
                <form className="flex flex-col items-center pt-2 md:pt-8 w-full">
                    <input
                        className="font-body my-2 py-2 px-4 block w-3/5 max-w-md rounded text-lg focus:ring-2 focus:border-transparent focus:ring-pink-500 outline-none border-2 border-gray-300 placeholder-gray-500"
                        type="email"
                        name=""
                        id=""
                        placeholder="Email"
                ...
                <div>
                    <p className="font-body font-bold text-center text-gray-800 pb-4">Login with</p>
                    <a
