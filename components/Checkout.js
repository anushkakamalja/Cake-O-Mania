            ...
            <div className="mt-36 ">
                ...
                <div className=" -mt-36">
                    <form
                        action=""
                        method="post"
                        className="flex flex-col min-w-full items-center font-body text-2xl">
                        <div className="flex flex-row min-w-full">
                            <div className="w-1/2 text-mybrown-100">
                                <h1 className="text-center font-header text-mybrown-100 text-5xl mt-10">
                                    Billing Details
                                </h1>
                                <div className="pt-5 ml-32">
                                    <p className=" pt-5">
                                        <p>Full Name*</p>
                                        <div className="py-2">
                                            <input
                        ...
                        <div className="w-full">
                            ...
                            <table className="w-3/4 mx-auto mt-5 text-2xl">
                                <thead className="border-4 border-grey bg-mygrey-200">
                                    <tr>
                                        <td className="font-bold py-4 pl-10">Product</td>
                                        <td className="font-bold py-y">Subtotal</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    {cartQuery.data.cart.items.map((cake) => (
                                        <Item
                                            cake={cartQuery.data.cakes[cake._id]}
                                            key={cake._id}
                                        />
                                    ))}

                                    <tr className="border-4 border-grey ">
                                        <td className="py-4 pl-10 text-rose-400 font-bold">
                                            Offer
                                        </td>
                                ...
                                <tfoot className="border-4 border-grey bg-mygrey-200">
                                    <tr>
                                        <td className="font-bold py-4 pl-10 text-myCyan-100">
                                            Total
                                        </td>
                                        <td className="font-bold py-4 text-myCyan-100">
                        ...
                        <a
                            ...
                            className="hover:text-white rounded-full text-3xl bg-mypink-100 text-white hover:bg-myCyan-100 transition duration-500 cursor-pointer py-5 px-10 mt-10">
                            Place Order
                        </a>
                    </form>
                </div>
...
const Item = ({ cake }) => {
    return (
        <>
            <tr className="border-4 border-grey ">
                <td className="py-4 pl-10">{cake.name}</td>
                <td className="py-4 ">{cake.price_per_half_kg}</td>
            </tr>
        </>
    );
};
